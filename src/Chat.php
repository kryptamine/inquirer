...
class Chat
{
    ...
    protected function getSummarizedMessage($dialogName, $runId)
    {
        ...
        if ($percentage < 50) {
            return "Вы ответили на все вопросы квиза за <b>{$timeRepresentation}</b> и набрали <b>{$value}</b> баллов из <b>{$maxValue}</b> возможных. . Количество ответов за которые вы получили баллы: <b>{$correctAnswersCount}</b>. \n\n<i>К сожалению, количества баллов недостаточно, чтобы участвовать в розыгрыше призов. Спасибо за игру!</i>";
        }
        return "Вы ответили на все вопросы квиза за <b>{$timeRepresentation}</b> и набрали <b>{$value}</b> баллов из <b>{$maxValue}</b> возможных. . Количество ответов за которые вы получили баллы: <b>{$correctAnswersCount}</b>. <b>Спасибо за игру!</b> Для того, чтобы участвовать в розыгрыше призов, пожалуйста оставьте нам вашу визитку с email, который вы указали при регистрации. Напоминаем, что розыгрыш призов победителям состоится согласно нашему расписанию на стенде.";
    }
